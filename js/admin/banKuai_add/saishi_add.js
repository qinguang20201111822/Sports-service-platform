define(['jquery', 'bootstrap', 'jquery_cookie',], function (jquery, bootstrap, jquery_cookie) {
    ...
    function add() {
        $(function () {
            $("#saishi_add").click(function () {
                $("#list_forUser").empty();
                var str = `
                <div class="panel-body">
                    <select id="part" class="form-control button  button-primary button-rounded">
                ...
                tinymce.init({
                    ...
                    content_style: "body {font-family:\"微软雅黑\";font-size:20px;height:200px; }",//自定义编辑器样式
