...
<body>
	<div id="top">
		...
		<ul class="nav">
			<li><a  target="_blank">二工大体育服务平台</a></li>
		</ul>
		<div class="login_info">
			<a href="/html/index.html" style="color:#fff;">网站首页</a>&nbsp;|&nbsp;
	...
	<div id="sidebar">
		<ul>
			...
			<li>
				...
				<ul class="child">
					<li><a <?php if(basename($_SERVER['SCRIPT_NAME'])=='member_module.php'){echo 'class="current"';}?> href="member_module.php">用户列表</a></li>			
				</ul>
			</li>
		</ul>
	</div>
