...
$width=120;
$height=40;
$element=array('2','3','4','5','6','7','8','9','a','b','c','d','e','f','g','h','i','j','k','m','n','o','p','q','r','s','t','u','v','w','x','y','z');
$string='';
for ($i=0;$i<4;$i++){
...
// imagestring($img,60,rand(15,35),rand(5,25),$string,$colorString);
imagettftext($img,30,rand(-5,5),rand(5,15),rand(30,35),$colorString,'/font/ManyGifts.ttf',$string);
imagejpeg($img);
imagedestroy($img);
return $string;
}
